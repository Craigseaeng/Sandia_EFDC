...
!
      ...
      REAL WQDOPD
      REAL WQDOPG
      REAL WQF1NC ! nutrient limitation multiplying factor
      REAL WQF1ND ! nutrient limitation multiplying factor
      REAL WQF1NG ! nutrient limitation multiplying factor
      REAL WQF2IC ! light limitation multiplying factor
      REAL WQF2ID ! light limitation multiplying factor
      REAL WQF2IG ! light limitation multiplying factor
      REAL WQFCDC
      REAL WQFCDD
      REAL WQFCDG
      REAL WQFCDM
      ...
      REAL WQMCMIN
      REAL WQNITM
      REAL WQPHDC !pH multiplying factor
      REAL WQPHDD !pH multiplying factor
      REAL WQPHDG !pH multiplying factor
      REAL WQPHC1 !WQ3DWC.inp card 52 constants for pH. VJ
      REAL WQPHC2
      REAL WQPHD1
      REAL WQPHD2
      REAL WQPHG1
...
!      REAL,ALLOCATABLE,DIMENSION(:,:)::DYV1
      ...
      REAL,ALLOCATABLE,DIMENSION(:,:)::PHVAL
...
!      REAL,ALLOCATABLE,DIMENSION(:)::WQPSQC  NOT USED
	  ...
	  REAL,ALLOCATABLE,DIMENSION(:,:)::XLIMPHC
	  REAL,ALLOCATABLE,DIMENSION(:,:)::XLIMPHD
	  REAL,ALLOCATABLE,DIMENSION(:,:)::XLIMPHG
...
! End SEDZLJ variables
      ...
      ! Begin Dissolved Carbondioxide variables
	  ...
	  REAL,ALLOCATABLE,DIMENSION(:,:)::WQGPH
	  REAL::LIM_NUT,LIM_LIT,LIM_TEM,LIM_PH
